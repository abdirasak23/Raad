...
const translations = {
    ...
    so: {
        ...
        // Ways Section
        ways_title: "Samee Iib Casri ah",
        ways_desc: "Ka gudub inaad iibka ku qorto buug - isticmaal habka casriga ah ee iibinta dhijitaalka ah.",
        old_way: "Habka Hore",
        old_way_desc: "Ku qorida iibka, daynta iyo faaidada hal buug",
        new_way: "Habka Cusub",
        new_way_desc: "Hal App hakuu sameeyo wax walba - Iibka, Daynta, iwm",
        ...
        step_1_title: "Soo Dagso Raad",
        step_1_desc: "Ka Dagso Raad Pos App playstore-ka",
        step_2_title: "Sameeso Cinwaan",
        step_2_desc: "Isdiiwaangeli emailkaaga oo u habeey profile ganacsigaaga.",
        step_3_title: "Ku Dar Alaabtaada",
        step_3_desc: "Si fudud ugi dar alaabta barcode leh, iyo kuwan laheen.",
        step_4_title: "Samee Iibin",
        step_4_desc: "Gad alaabta, isticmaal lacag bixino kala duwan.",
        ...
        business_desc: "App loogu talagalay milkiileyaasha dukaamada dhabta ah iyo iibiyeyaasha caadiga ah.",
        bus_grocery: "Dukaan Xaafadeed",
        bus_grocery_desc: "Cuntada maalinlaha ah iyo waxyaabaha guriga loo isticmaalo.",
        bus_clothing: "Carwooyinka Dharka",
        bus_clothing_desc: "Dharka moodeelka, qalabyada, iyo dharka quruxda badan.",
        bus_cosmetics: "Dukaamada Isqurxinta",
        bus_cosmetics_desc: "Makeupka, daryeelka maqaarka, iyo alaabta quruxda.",
        bus_electronics: "Elektarooniga",
        bus_electronics_desc: "Taleefannada, qalabka casriga ah, iyo qalabyada elektarooniga ah.",
        bus_bookshop: "Stationery-yada",
        ...
        // Footer
        footer_desc: "RAAD POS waa App caqli Leh, degdeg ah, oo fudud oo loogu talagalay ganacsiyada yaryar iyo kuwa dhexdhexaad ah. Maareey iibinta, raadi alaabta, oo si fudud u maamul dukaamadaada.",
